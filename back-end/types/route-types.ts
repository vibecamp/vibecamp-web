import { Tables, attendee__attendee_id_Type } from "./db-types.ts";
...
export type Routes = {
  ...
  "/event/save": {
    ...
    body: {
      event: Omit<
        EventJson,
        "created_by_account_id" | "event_id" | "event_type"
      > & {
...
export type NewApplication = Omit<
  Tables["application"],
  "application_id" | "submitted_on" | "is_accepted"
>;
...
export type Purchases = Partial<
  Record<Tables["purchase_type"]["purchase_type_id"], number>
>;
